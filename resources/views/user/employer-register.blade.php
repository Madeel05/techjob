        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card" id="card">
                    ...
                    <form action="#" method="post" autocomplete="off" id="registrationForm"><div class="card-body">
    ...
    <script>
        ...
        document.getElementById("btnRegister").addEventListener("click", function (event) {
            ...
            fetch(url, {
                ...
                button.innerHTML = 'Register';
                button.disabled = false;
                message.innerHTML = '<div class="alert alert-success">Something went wrong. Please try again</div>'
            })
        });
    </script>
@endsection
